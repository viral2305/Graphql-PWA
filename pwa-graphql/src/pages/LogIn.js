      ...
      <div className="flex w-full lg:w-1/2 justify-center items-center bg-white space-y-8">
        <div className="w-full px-8 md:px-32 lg:px-24">
          <form className="bg-white rounded-md shadow-2xl p-5">
            ...
            <h1 className="text-gray-800 font-bold text-2xl mb-1 text-center">Log-In</h1>
            ...
            <div className="flex items-center border-2 mb-12 py-2 px-3 rounded-2xl">
              ...
              <input className="pl-2 w-full outline-none border-none" type={passwordVisible ? 'text': 'password'} name="password" id="password"
              ...
              {!passwordVisible ? <svg className="h-5 w-5 fill-gray-400" onClick={PasswordIndicator}
                ...
                : <svg className="h-5 w-5 fill-gray-400" onClick={PasswordIndicator} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><path d="M150.7 92.77C195 58.27 251.8 32 320 32C400.8 32 465.5 68.84 512.6 112.6C559.4 156 590.7 207.1 605.5 243.7C608.8 251.6 608.8 260.4 605.5 268.3C592.1 300.6 565.2 346.1 525.6 386.7L630.8 469.1C641.2 477.3 643.1 492.4 634.9 502.8C626.7 513.2 611.6 515.1 601.2 506.9L9.196 42.89C-1.236 34.71-3.065 19.63 5.112 9.196C13.29-1.236 28.37-3.065 38.81 5.112L150.7 92.77zM223.1 149.5L313.4 220.3C317.6 211.8 320 202.2 320 191.1C320 180.5 316.1 169.7 311.6 160.4C314.4 160.1 317.2 159.1 320 159.1C373 159.1 416 202.1 416 255.1C416 269.7 413.1 282.7 407.1 294.5L446.6 324.7C457.7 304.3 464 280.9 464 255.1C464 176.5 399.5 111.1 320 111.1C282.7 111.1 248.6 126.2 223.1 149.5zM320 480C239.2 480 174.5 443.2 127.4 399.4C80.62 355.1 49.34 304 34.46 268.3C31.18 260.4 31.18 251.6 34.46 243.7C44 220.8 60.29 191.2 83.09 161.5L177.4 235.8C176.5 242.4 176 249.1 176 255.1C176 335.5 240.5 400 320 400C338.7 400 356.6 396.4 373 389.9L446.2 447.5C409.9 467.1 367.8 480 320 480H320z"/></svg>
              }

            </div>
            <button type="button" className="block w-full bg-green-600 mt-5 py-2 rounded-2xl hover:bg-green-800 hover:-translate-y-1 transition-all duration-500 text-white font-semibold mb-2" onClick={handelSubmit}>Login
            </button>
